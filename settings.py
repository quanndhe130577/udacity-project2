#--------- Flask settings
SERVER_HOST = 'https://project2appservice.azurewebsites.net' # Update this for the appropriate front-end website when up
SERVER_PORT = 5000
...
API_URL = "https://project2functionapp1.azurewebsites.net/api/"
